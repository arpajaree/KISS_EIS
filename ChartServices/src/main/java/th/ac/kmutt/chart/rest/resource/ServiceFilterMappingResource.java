                ...
                if (xsource != null) {
                    ...
                    if (xsource.getServiceName() != null
                        ...
                        if (serviceName.equals(ServiceConstant.SERVICE_FILTER_MAPPING_FIND_BY_ID)) {
                            ...
                            java.util.ArrayList<ServiceFilterMappingEntity> domains = (java.util.ArrayList<ServiceFilterMappingEntity>)
                                    chartService.listServiceFilterMappingEntity(xsource);
                            List<ServiceFilterMappingM> models = new ArrayList<ServiceFilterMappingM>(domains.size());
                            models = getServiceFilterMappingModels(domains);
                            ImakeResultMessage imakeMessage = new ImakeResultMessage();
                            imakeMessage.setResultListObj(models);
                            return getRepresentation(entity, imakeMessage, xstream);
